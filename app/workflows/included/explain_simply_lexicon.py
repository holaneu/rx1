...
def explain_simply_lexicon(input, model=None):
    ...
    try:
        ...
        ai_data = wf.get_assistant_output_or_raise(explain_simply_lexicon(input=input.strip(), model=model))
        wf.log_msg(msgTitle="Lexicon explanation generated by LLM", msgBody=ai_data)
