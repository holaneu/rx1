...
def logbook_entry(input, task_id, model=None):
    ...
    try:
        ...
        """
        entry = wf.get_assistant_output_or_raise(universal_no_instructions(input=instructions, model="gpt-4o", structured_output=True)).strip()
        wf.log_msg(msgTitle="Logbook entry generated by LLM", msgBody=entry)
        try:
