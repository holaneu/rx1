...
from app.tools import save_to_file, user_data_files_path, generate_id, current_datetime_iso
...
def quiz_from_text(input, model=None):	
    ...
    try:
        ...
        questions = wf.get_assistant_output_or_raise(universal_no_instructions(input=instructions_questions, model="gpt-4o"))
        wf.log_msg(msgTitle="Questions generated by LLM", msgBody=questions)
        ...
        """
        quiz_questions = wf.get_assistant_output_or_raise(universal_no_instructions(input=instructions_quiz_questions, model="gpt-4o"))
        wf.log_msg(msgTitle="Quiz questions generated by LLM", msgBody=quiz_questions)
