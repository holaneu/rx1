...
def quiz_from_text(input, model=None):	
    ...
    try:
        ...
        wf.add_msg_to_log(msgTitle="Questions generated by LLM", msgBody=questions)
        ...
        wf.add_msg_to_log(msgTitle="Quiz questions generated by LLM", msgBody=quiz_questions)
