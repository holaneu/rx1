...
def quiz_from_text(input, model=None):	
    ...
    try:
        ...
        wf.add_to_func_log(msgTitle="Questions generated by LLM", msgBody=questions)
        ...
        wf.add_to_func_log(msgTitle="Quiz questions generated by LLM", msgBody=quiz_questions)
