...
def write_story_reviewed(input, model=None):
    ...
    try:
        ...
        wf.add_msg_to_log(msgTitle="Editor feedback generated by LLM", msgBody=editor_feedback)
        ...
        wf.add_msg_to_log(msgTitle="Edited story generated by LLM", msgBody=writer_edited_story)
