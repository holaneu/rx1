...
def write_story_reviewed(input, model=None):
    ...
    try:
        ...
        wf.add_to_func_log(msgTitle="Story generated by LLM", msgBody=story)
        ...
        wf.add_to_func_log(msgTitle="Editor feedback generated by LLM", msgBody=editor_feedback)
        ...
        wf.add_to_func_log(msgTitle="Edited story generated by LLM", msgBody=writer_edited_story)
